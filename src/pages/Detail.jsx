...
const Detail = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    apiRequest(`rest/v1/tasks/${tasks_id}`, "post", objSubmit, "multipart/form-data")
      .then((res) => {
        alert("List Edited");
        setObjSubmit({});
        navigate("/");
        ...
        <div className="flex justify-center mt-8">
          <div className="w-5/6 md:w-2/3 flex flex-col justify-center">
            ...
            <form className="flex flex-col gap-4 w-full" onSubmit={(e) => handleSubmit(e)}>
              ...
              {/* <Input type="select" placeholder="Are you completed? Yes / No" value={completed === false ? "Not Completed" : "Completed"} onChange={(e) => handleChange(e.target.value, "completed")} /> */}
